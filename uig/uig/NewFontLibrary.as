...
@mxmlc -o bin/NewFontLibrary.swf -static-link-runtime-shared-libraries=true -noplay
*/
package uig.uig 
{
	...
	/**
	 * Font library
	 * @author Gatien Goteni
	 */
	public class NewFontLibrary extends Sprite 
	{
		/*
		...
		*/
		...
		[Embed(source='NewFontLibrary.ttf'
		,fontFamily  ='NewFontLibrary'
		...
		public function NewFontLibrary() 
		{
